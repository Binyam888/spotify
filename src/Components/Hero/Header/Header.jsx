  ...
  return (
    <div className='Heder-container flex justify-between p-3 px-[50px]'>
        ...
        <div className="header-button  text-center">
            <button className='mx-5 text-[20px] font-semibold hover:text-white hover:scale-105 duration-200'>Sign up</button>
            <button className='bg-white p-2 text-black rounded-full text-[18px] font-semibold w-[100px] text-center hover:scale-105 duration-100'>Log In</button>
        </div>
