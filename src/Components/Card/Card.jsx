...
function Card() {
  return (
    <div className='card-container group  mt-[20px] ml-[25px] bg-neutral-800 w-[180px] p-3 rounded-lg cursor-pointer hover:bg-neutral-700 duration-200 '> 
    ...
    <FaPlayCircle size={44} color='green' className='mt-[95px] mr-[12px] bg-black rounded-full hover:scale-105 duration-200 ' />
    </div>
